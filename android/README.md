...
与 Windows 共享：`schema_version=6`、`data_format_version=1`、内容寻址对象库、`.ebpack` v1。Android 当前只导入未加密包；schema v5/v6 新增的候选区域与 intake 暂存表属于 Windows 录题过程元数据，不在 Android UI 中提供对应功能。
